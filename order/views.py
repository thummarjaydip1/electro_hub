...
def order_display(request):
    ...
    return render(request,"order/order_display.html",{"data":data,"status_fields":status_fields})
...
def pdf_download(request,id):
    try:
        ...
        response["Content-Disposition"] = f'attachment; filename = {data.user}_{data.product_name}_{data.id}_bill.pdf'
