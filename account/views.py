...
def auth_profile(request):
    ...
    res = requests.get("https://www.timeapi.io//api/v1/time/current/zone?timeZone=Asia/Kolkata")
    data = res.json()
    return render(request,"account/profile.html",{"profile":profile,"data":data})
